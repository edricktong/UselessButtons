package com.example.uselessbuttons;
    ...
    private void setListeners() {
        uselessSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if (isChecked) {
                    Toast.makeText(MainActivity.this, "Excellent, You did it!", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(MainActivity.this, "SIKE Get Roasted!", Toast.LENGTH_SHORT).show();
                }
